...
// Source: antrea.io/nephe/pkg/cloudprovider/cloudapi/common (interfaces: CloudInterface)
...
import (
	...
	common "antrea.io/nephe/pkg/cloudprovider/cloudapi/common"
...
func (m *MockCloudInterface) CreateSecurityGroup(arg0 *securitygroup.CloudResource, arg1 bool) (*string, error) {
	m.ctrl.T.Helper()
...
func (m *MockCloudInterface) DeleteSecurityGroup(arg0 *securitygroup.CloudResource, arg1 bool) error {
	m.ctrl.T.Helper()
...
func (m *MockCloudInterface) ProviderType() common.ProviderType {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ProviderType")
	ret0, _ := ret[0].(common.ProviderType)
	return ret0
}
...
func (m *MockCloudInterface) UpdateSecurityGroupMembers(arg0 *securitygroup.CloudResource, arg1 []*securitygroup.CloudResource, arg2 bool) error {
	m.ctrl.T.Helper()
