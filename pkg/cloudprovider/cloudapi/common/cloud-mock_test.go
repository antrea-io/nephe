...
func (m *MockCloudInterface) CreateSecurityGroup(securityGroupIdentifier *cloudresource.CloudResource, membershipOnly bool) (*string, error) {
	m.ctrl.T.Helper()
...
func (m *MockCloudInterface) DeleteSecurityGroup(securityGroupIdentifier *cloudresource.CloudResource, membershipOnly bool) error {
	m.ctrl.T.Helper()
...
func (m *MockCloudInterface) InstancesGivenProviderAccount(accountNamespacedName, selectorNamespacedName *types.NamespacedName) (map[string]*v1alpha10.VirtualMachine, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InstancesGivenProviderAccount", accountNamespacedName, selectorNamespacedName)
...
func (mr *MockCloudInterfaceMockRecorder) InstancesGivenProviderAccount(accountNamespacedName, selectorNamespacedName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InstancesGivenProviderAccount", reflect.TypeOf((*MockCloudInterface)(nil).InstancesGivenProviderAccount), accountNamespacedName, selectorNamespacedName)
}
...
// InstancesGivenProviderAccount mocks base method.
func (m *MockComputeInterface) InstancesGivenProviderAccount(accountNamespacedName, selectorNamespacedName *types.NamespacedName) (map[string]*v1alpha10.VirtualMachine, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InstancesGivenProviderAccount", accountNamespacedName, selectorNamespacedName)
	ret0, _ := ret[0].(map[string]*v1alpha10.VirtualMachine)
	ret1, _ := ret[1].(error)
...
// InstancesGivenProviderAccount indicates an expected call of InstancesGivenProviderAccount.
func (mr *MockComputeInterfaceMockRecorder) InstancesGivenProviderAccount(accountNamespacedName, selectorNamespacedName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InstancesGivenProviderAccount", reflect.TypeOf((*MockComputeInterface)(nil).InstancesGivenProviderAccount), accountNamespacedName, selectorNamespacedName)
}
