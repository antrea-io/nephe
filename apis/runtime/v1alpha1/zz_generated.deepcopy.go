...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SG) DeepCopyInto(out *SG) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SG.
func (in *SG) DeepCopy() *SG {
	if in == nil {
		return nil
	}
	out := new(SG)
