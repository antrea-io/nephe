...
// nolint:lll
// +kubebuilder:webhook:path=/mutate-crd-cloud-antrea-io-v1alpha1-virtualmachine,mutating=true,failurePolicy=fail,groups=crd.cloud.antrea.io,resources=virtualmachines,verbs=create;update,versions=v1alpha1,name=mvirtualmachine.kb.io,sideEffects=None,admissionReviewVersions=v1;v1beta1
...
// nolint:lll
// +kubebuilder:webhook:verbs=create;update,path=/validate-crd-cloud-antrea-io-v1alpha1-virtualmachine,mutating=false,failurePolicy=fail,groups=crd.cloud.antrea.io,resources=virtualmachines,versions=v1alpha1,name=vvirtualmachine.kb.io,sideEffects=None,admissionReviewVersions=v1;v1beta1
