...
```bash
./install-vm-agent-wrapper.sh --ns vm-ns --antrea-version v1.13.0 --kubeconfig ./antrea-agent.kubeconfig \
...
```powershell
.\install-vm-agent-wrapper.ps1 -Namespace vm-ns -AntreaVersion v1.13.0 -KubeConfigPath .\antrea-agent.kubeconfig `
